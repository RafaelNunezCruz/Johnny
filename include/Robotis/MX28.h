...
namespace Robot
{
	...
	public:
		...
		enum
		{
            ...
            P_D_ERROR_OUT_L             = 66,
            P_D_ERROR_OUT_H             = 67,
            P_CURRENT_L                 = 68, //Added for compatibility with MX64
            P_CURRENT_H                 = 69, //Added for compatibility with MX64
            P_TORQUE_CONTROL_MODE_ENABLE= 70, //Added for compatibility with MX64
            P_GOAL_TORQUE_L             = 71, //Added for compatibility with MX64
            P_GOAL_TORQUE_H             = 72, //Added for compatibility with MX64
            P_GOAL_ACCELERATION         = 73, //Added for compatibility with MX64
			MAXNUM_ADDRESS
		};
#endif
	};
